...
/** 
 * code taken from: https://stackoverflow.com/a/24344967 only done minor changes
 **/
public class PerspectiveTransform {

	public static BufferedImage computeToPoints(BufferedImage image,
	...
	public static BufferedImage computeFromPoints(BufferedImage image,
			Point2D p0, Point2D p1, Point2D p2, Point2D p3){
		int w = image.getWidth();
		int h = image.getHeight();
